" Modified version of github.com/justb3a/smarties.vim
...
if !exists("g:smarties_background_color")
  let g:smarties_background_color = "0A0E14"
end

call s:X("Normal","FEC4D3",g:smarties_background_color,"","Blue","") " keep
set background=dark
...
if version >= 700
  ...
  call s:X("TabLine","F60761","","italic","",s:termBlack)
...
call s:X("Statement","ff33cc","","","LightMagenta","")
call s:X("PreProc","8900eb","","","","")

hi! link Operator Normal

call s:X("Type","f70560","","","Yellow","")
